...
import liblinear
from liblinearutil import train as liblinear_train, predict as liblinear_predict, save_model as liblinear_save_model, \
    load_model as liblinear_load_model
...
class LearnerProblem(liblinear.problem):
    ...
    def normalize(self, learner_param, idf):
        print_debug(
            "normal parameters: bin_feat {0}, inst_norm {1}, tf {2}, idf {3}\n".format(learner_param.binary_feature,
